...
Welcome to the [**Currencies Archiving & Sharing Hub (CASH)**](https://cash-hub.vercel.app/), your gateway to organizing and showcasing your currency collection to the world. This open-source project is built to serve collectors while inviting contributions to grow its features and reach.
...
[Demo Live](https://cash-hub.vercel.app/) (Developer's Own Showroom)
...
1. Open an issue on the [GitHub repository](https://github.com/makkahwi/cash-hub/issues).
...
👉 **[Click here to star the repo](https://github.com/makkahwi/cash-hub/stargazers)** 👈  

[![GitHub stars](https://img.shields.io/github/stars/makkahwi/cash-hub?style=social)](https://github.com/makkahwi/cash-hub/stargazers)
...
- **[Share on Twitter (X)](https://twitter.com/intent/tweet?text=Check+out+this+amazing+open-source+project+for+currency+collectors!+Currencies+Archiving+and+Sharing+Hub+is+a+Vue.js+and+Firebase-based+app+that+lets+you+showcase+your+collections+online!+%23OpenSource+%23CurrencyCollector&url=https://github.com/makkahwi/cash-hub/)**  
- **[Share on LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https://github.com/makkahwi/cash-hub/&title=Check+out+Currencies+Archiving+and+Sharing+Hub!&summary=An+open-source+project+for+currency+collectors+to+showcase+their+collections+online.&source=)**  
- **[Share on Facebook](https://www.facebook.com/sharer/sharer.php?u=https://github.com/makkahwi/cash-hub/)**  
- **[Share on Reddit](https://www.reddit.com/submit?url=https://github.com/makkahwi/cash-hub/&title=Check+out+Currencies+Archiving+and+Sharing+Hub%21)**  
