        ...
        >
          ...
          <template #list>
            <ul class="nav ms-4">
              ...
              <SidenavItem to="/" mini-icon="P" text="Landing" />
            ...
            <ul class="nav ms-4">
              ...
              >
                <template #nav-child-item>
                  ...
                  />
                  <SidenavItem
                    to="/ecommerce/products/edit-product"
                    mini-icon="E"
                    text="Edit Product"
                  />
                  <SidenavItem
                    to="/ecommerce/products/product-page"
                    mini-icon="P"
                    text="Product page"
                  />
                  <SidenavItem
                    to="/ecommerce/products/product-list"
                    mini-icon="P"
                    text="Products List"
                  />
                </template>
              ...
              >
                <template #nav-child-item>
                  ...
                  />
                  <SidenavItem
                    to="/ecommerce/orders/order-details"
                    mini-icon="O"
                    text="Order Details"
                  />
                </template>
