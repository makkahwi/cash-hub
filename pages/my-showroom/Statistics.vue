<template>
  <PageSection title="Statistics" subtitle="Overview of shown data" bg="light">
    <div class="row g-0 text-center">
      <div
        v-for="{ title, value } of statsData()"
...
const statsData = () => [
  ...
  },
  {
    ...
    value: "78",
    value: props.currencies.filter(({ continent }) => continent == "Africa")
      ?.length,
  },
  {
    title: "Count of American Pieces",
    value: "60",
    value: props.currencies.filter(({ continent }) => continent == "America")
      ?.length,
  },
  {
    title: "Count of Asian Pieces",
    value: "333",
    value: props.currencies.filter(({ continent }) => continent == "Asia")
      ?.length,
  },
  {
    title: "Count of Europen Pieces",
    value: "56",
    value: props.currencies.filter(({ continent }) => continent == "Europe")
      ?.length,
  },
  {
    title: "Count of Oceanian Pieces",
    value: "22",
    value: props.currencies.filter(({ continent }) => continent == "Oceania")
      ?.length,
  },
];
</script>
