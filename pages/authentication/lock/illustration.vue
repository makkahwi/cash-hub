        ...
        <div class="row">
              ...
              <div class="card-body text-center">
                ...
                <form role="form">
                  ...
                  <div class="text-center">
                    <ArgonButton color="dark" full-width size="lg">
                      Unlock
                    </ArgonButton>
                  </div>
                </form>
          ...
          >
            <div
              ...
              style="
                background-image: url('https://raw.githubusercontent.com/arromicreatives/public-assets/master/argon-dashboard-pro/assets/img/lock-ill.jpg');
