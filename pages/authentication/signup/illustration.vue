        ...
        <div class="row">
            ...
            <div class="card card-plain">
              ...
              <div class="card-footer text-center pt-0 px-sm-4 px-1">
                <p class="mb-4 mx-auto">
                  ...
                  <NuxtLink to="/" class="text-success font-weight-bolder">
                    Sign in
                  </NuxtLink>
                </p>
              </div>
          ...
          >
            <div
              ...
              style="
                background-image: url('https://raw.githubusercontent.com/arromicreatives/public-assets/master/argon-dashboard-pro/assets/img/signup-ill.jpg');
