<template>
  <NuxtLayout name="authentication">
    ...
    <div
      ...
      style="
        background-image: url('https://raw.githubusercontent.com/arromicreatives/public-assets/master/argon-dashboard-pro/assets/img/signin-cover.jpg');
      "
    >
          ...
          <div class="card mt-5">
            ...
            <div class="card-body">
              <form role="form" class="text-start">
                ...
                <div class="text-center">
                  <ArgonButton color="success" full-width class="mt-4 mb-0"
                    >Sign in</ArgonButton
                  >
                </div>
              </form>
            ...
            <div class="card-footer text-center pt-0 px-lg-2 px-1">
              <p class="mb-4 text-sm mx-auto">
                ...
                <NuxtLink to="/" class="text-success font-weight-bold"
                  >Sign up</NuxtLink
                >
              </p>
            </div>
