<template>
  <PageSection bg="success" color="white" title="Coming Soon Features">
    <h5 class="text-white lh-lg">
      As of this moment, you could use the admin panel to add the currencies collection and the public showroom to view them. Soon, a new admin panel will be built to not only include data input controls, but also a dashboard to provide reports & data analysis about the collection.
    </h5>
  </PageSection>
